...
public class Anjuke_Rentout{
	...
	public static String FOLDER1 = "/home/gir/crawldata/beijing/anjuke/rentout/anjuke_rentout0414.txt";
	public static String FOLDER2 = "/home/gir/crawldata/beijing/anjuke/rentout/anjuke_rentout0414_zhoubian.txt";
							...
							if (m != -1 && k != -1)
							{
								...
								else
								{
									...
									//synchronized是Java语言的关键字，当它用来修饰一个方法或者一个代码块的时候，能够保证在同一时刻最多只有一个线程执行该段代码。
									{
										...
										//FileTool.Dump(poi, FOLDER+"/rental/Anjuke_RentalInfo.txt", "UTF-8");
									}
								}
							}
						}
